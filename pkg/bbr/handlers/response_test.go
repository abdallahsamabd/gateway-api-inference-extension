...
func TestHandleResponseBody_NoPlugins(t *testing.T) {
	...
	resp, err := server.HandleResponseBody(ctx, responseBody, logger)
	if err != nil {
...
func TestHandleResponseBody_PluginError(t *testing.T) {
	...
	_, err := server.HandleResponseBody(ctx, responseBody, logger)
	if err == nil {
...
func TestProcessResponseBody_Streaming(t *testing.T) {
	...
	resp1, err := server.processResponseBody(ctx, chunk1, respStreamedBody, logger)
	if err != nil {
	...
	resp2, err := server.processResponseBody(ctx, chunk2, respStreamedBody, logger)
	if err != nil {
